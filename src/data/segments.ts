const SEGMENTS = [
  ...
  },
  {
    ...
    highlightParts: ['压力变送器', '位移传感器', '流量计', '防泄露传感器', '防爆摄像头', '阀位指示', '压差变送器', '自驱动电源'],
  },
  {
    title: '远程调控',
    ...
    camera: { pos: [-0.06, 0.6, 0.68], target: [0.02, 0.34, 0.03] },
    highlightParts: ['电动调节阀', '远程切断装置'],
  },
  {
    title: '在线诊断',
    ...
    camera: { pos: [1.3, 1.12, 0.26], target: [0.11, 0.98, 0.31] },
    highlightParts: ['压力变送器', '位移传感器'],
  },
  {
    title: '供电保障',
    ...
    camera: { pos: [0.93, 1.44, -1.45], target: [-0.38, 0.39, -0.51] },
    highlightParts: ['自驱动电源'],
  },
  {
    title: '扩展安全',
    body: '调压箱进口增电动调节阀，下游管网关键节点布设传感设备，依托专业模型数据建模分析，实现下游管网微小泄漏风险早期预警，提升区域燃气供应安全等级。',
    image: 'placeholder/safety-and-hmi.png',
    camera: { pos: [0.14, 1.2, 1.7], target: [0.2, 0.2, -0.1] },
    highlightParts: ['防爆法兰电动调节阀', '压力变送器'],
  },
  {
    title: '自驱电源',
